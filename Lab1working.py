        ...
        if not visited[xn][yn]:
            ...
            if rgbterrain.getpixel(current) == (0, 0, 255):
                for n in range(15, 0, -1):
                    if not xn + n >= row:
                        if rgbterrain.getpixel((xn + n, yn)) != (0, 0, 255) and rgbterrain.getpixel((xn + n, yn)) != (205, 0, 101) and rgbterrain.getpixel((xn + n, yn)) != (210, 105, 30) and (float(elevations[xn + n][yn]) - float(elevations[xn][yn])) <= 1:
                            for k in range(n):
                                if rgbterrain.getpixel((xn + k, yn)) != (0, 0, 255) and rgbterrain.getpixel(
                                        (xn + k, yn)) != (205, 0, 101):
                                    visited[xn + k][yn] = True
                                    rgbterrain.putpixel((xn + k, yn), (210, 105, 30))

                        else:
                            visitedqueue.put((xn + n, yn))
                    if not xn - n < 0:
                        if rgbterrain.getpixel((xn - n, yn)) != (0, 0, 255) and rgbterrain.getpixel((xn - n, yn)) != (205, 0, 101) and rgbterrain.getpixel((xn - n, yn)) != (210, 105, 30) and (
                                float(elevations[xn - n][yn]) - float(elevations[xn][yn])) <= 1:
                            for k in range(n):
                                if rgbterrain.getpixel((xn - k, yn)) != (0, 0, 255) and rgbterrain.getpixel(
                                        (xn - k, yn)) != (205, 0, 101):
                                    visited[xn - k][yn] = True
                            ...
                            visitedqueue.put((xn - n, yn))
                    if not yn + n >= col:
                        if rgbterrain.getpixel((xn, yn + n)) != (0, 0, 255) and rgbterrain.getpixel((xn, yn + n)) != (205, 0, 101) and rgbterrain.getpixel((xn, yn + n)) != (210, 105, 30) and (
                                float(elevations[xn][yn + n]) - float(elevations[xn][yn])) <= 1:
                            for k in range(n):
                                if rgbterrain.getpixel((xn, yn + k)) != (0, 0, 255) and rgbterrain.getpixel(
                                        (xn, yn + k)) != (205, 0, 101):
                                    visited[xn][yn + k] = True
                                    rgbterrain.putpixel((xn, yn + k), (210, 105, 30))
                        else:
                            visitedqueue.put((xn, yn + n))
